        ...
        <div className="flex flex-col gap-2 sm:gap-3 bg-primary/5 rounded-lg p-3 sm:p-6 border border-primary/10">
          {isLoading ? (
            ...
            <>
              ...
              <div className="flex items-center justify-between">
                <span className="text-base sm:text-lg font-semibold text-primary">Admin Profit</span>
                <span className="text-lg sm:text-2xl font-bold text-blue-500">৳ {wallet?.adminProfit?.toLocaleString()}</span>
              </div>
              <div className="flex items-center justify-between">
