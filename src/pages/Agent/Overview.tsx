    ...
    <div className="flex justify-center items-center min-h-[60vh] bg-background">
      <div className="w-full max-w-md bg-white dark:bg-muted rounded-xl shadow-lg p-4 sm:p-8 flex flex-col gap-6 sm:gap-8 border border-primary/20">
        ...
        <div className="flex flex-col gap-2 sm:gap-3 bg-primary/5 rounded-lg p-3 sm:p-6 border border-primary/10">
          ...
          <div className="flex items-center justify-between">
            <span className="text-base sm:text-lg font-semibold text-primary">Commission</span>
            <span className="text-lg sm:text-2xl font-bold text-blue-500">৳ {wallet?.commission?.toLocaleString()}</span>
          </div>
          <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2 sm:gap-4 justify-between mt-2">
          <Button className="flex-1 text-xs sm:text-base py-2 cursor-pointer sm:py-3" variant="outline" onClick={() => navigate('/agent/cashin')}>Cash In</Button>
          <Button className="flex-1 text-xs sm:text-base py-2 cursor-pointer sm:py-3" variant="outline" onClick={() => navigate('/agent/cashout')}>Cash Out</Button>
          <Button className="flex-1 text-xs sm:text-base py-2 cursor-pointer sm:py-3" variant="outline" onClick={() => navigate('/agent/transactions')}>Transactions</Button>
        </div>
      </div>
    </div>
  );
